...
const contactInfo = [
  ...
  { icon: GitHubIcon, label: "GitHub", value: "github.com/yeshi-2001", href: "https://github.com/yeshi-2001" },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        EMAILJS_SERVICE_ID,
        EMAILJS_TEMPLATE_ID,
        { name: form.name, email: form.email, message: form.message, to_email: "yeshikabandara2001@gmail.com" },
