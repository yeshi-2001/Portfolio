    ...
    >
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute inset-0" style={{
          background: isDark
            ? "radial-gradient(ellipse 80% 60% at 50% 50%, #0b1212 30%, #0c2523 60%, #0b1212 100%)"
            : "radial-gradient(ellipse 80% 60% at 50% 50%, #e0faf9 30%, #b2f0ec 60%, #e0faf9 100%)"
        }} />
        <div className="absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full" style={{
          background: isDark
            ? "radial-gradient(circle, rgba(18,203,192,0.12) 0%, transparent 70%)"
            : "radial-gradient(circle, rgba(18,203,192,0.1) 0%, transparent 70%)",
          filter: "blur(60px)"
        }} />
        <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] rounded-full" style={{
          background: isDark
            ? "radial-gradient(circle, rgba(15,140,133,0.3) 0%, transparent 70%)"
            : "radial-gradient(circle, rgba(15,140,133,0.1) 0%, transparent 70%)",
          filter: "blur(60px)"
        }} />
        ...
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg"
          ...
          <g filter="url(#glow)" stroke="#10ada3" strokeWidth="0.3" fill="none">
          ...
          <g filter="url(#glow-strong)" fill="#12cbc0">
          ...
          <g filter="url(#glow)" stroke="#0f8c85" strokeWidth="0.3" fill="none">
          ...
          <g filter="url(#glow-strong)" fill="#11bdb2">
          ...
          <g filter="url(#glow)" stroke="#10ada3" strokeWidth="0.2" fill="none">
        ...
        <div className="absolute top-0 left-0 right-0 h-px" style={{
          background: "linear-gradient(90deg, transparent, rgba(18,203,192,0.3), transparent)"
        }} />
        <div className="absolute inset-0" style={{
          background: isDark
            ? "radial-gradient(ellipse 100% 100% at 50% 50%, transparent 40%, rgba(0,0,0,0.6) 100%)"
            : "radial-gradient(ellipse 100% 100% at 50% 50%, transparent 40%, rgba(178,240,236,0.4) 100%)"
        }} />
      </div>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-16 md:gap-20">
          <div className="flex-1 text-center md:text-left">
            ...
            >
              <button
                ...
                style={{ background: "linear-gradient(135deg, var(--cta), var(--cta-hover))", color: "var(--bg-primary)", boxShadow: "0 4px 20px rgba(18,203,192,0.35)" }}
              >
                View Projects
              </button>
              <button
                ...
                style={{ color: "var(--text-primary)", border: "1px solid var(--border-color)", background: "rgba(18,203,192,0.1)", backdropFilter: "blur(8px)" }}
              >
                Contact Me
              </button>
              <a
                href="/Y.M_Yeshika_B._Bandara_.pdf"
                download="Y.M_Yeshika_B._Bandara_.pdf"
            ...
            >
              {[
                ...
                <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                  ...
                  style={{ background: "rgba(18,203,192,0.08)", color: "var(--accent)", border: "1px solid var(--border-color)" }}
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 rounded-full" style={{ background: "linear-gradient(135deg, var(--cta), var(--accent))", filter: "blur(20px)", opacity: isDark ? 0.25 : 0.15, transform: "scale(1.1)" }} />
              <div className="rounded-full p-[3px] relative" style={{ background: "linear-gradient(135deg, var(--cta), var(--accent))", boxShadow: "0 0 30px rgba(18,203,192,0.2)" }}>
                <div className="rounded-full p-[3px]" style={{ background: "var(--bg-primary)" }}>
                  <div className="rounded-full overflow-hidden w-56 h-56 md:w-72 md:h-72">
                    <Image src="/profile.jpg" alt="Yeshika B. Bandara" width={288} height={288} className="w-full h-full object-cover object-[50%_20%]" priority loading="eager" />
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-3 -right-3 rounded-2xl px-3 py-2 shadow-lg"
                style={{ background: "var(--bg-card)", border: "1px solid var(--card-border)", backdropFilter: "blur(12px)", color: "var(--text-primary)" }}>
                <p className="text-xs font-semibold text-center">Software Engineer</p>
                <p className="text-xs text-center" style={{ color: "var(--cta)" }}>Intern</p>
              </div>
            </div>
          </motion.div>
        </div>
