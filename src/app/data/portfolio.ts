...
export const skills = [
  { category: "Programming", items: ["Python", "Java", "JavaScript", "C++"] },
  { category: "Frontend", items: ["React.js", "Tailwind CSS"] },
  { category: "Backend", items: ["Flask", "Spring Boot", "Node.js", "Express.js"] },
  { category: "Databases", items: ["MySQL", "PostgreSQL", "MongoDB"] },
  { category: "Cloud & DevOps", items: ["AWS", "Docker", "Firebase"] },
  { category: "Tools", items: ["GitHub", "Postman", "VS Code"] },
];
...
export const experience = [
  {
    ...
    period: "University",
    description: "Assisted in organizing tech events, workshops, and society activities.",
  },
  {
    role: "School Prefect",
    org: "School Leadership",
    period: "2018 – 2020",
    description: "Led student initiatives and maintained discipline as a senior prefect.",
  },
];
